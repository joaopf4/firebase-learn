...
function App() {
  ...
  async function buscaPost() {
    ...
    //   .doc('1234')
    //   .get() //vai buscar os dados do post/doc de id 123. Os dados chegam como promises
          ...
          {posts.map((post) => {
            return(
              <li key={post.id}>
                ...
                <button onClick={ () => handleEdit(post.id)}>Editar post</button><br/>
                <button onClick={ () => handleDelete(post.id)}>Excluir post</button><br/><br/>
              </li>
            )
          })}
        </ul>
